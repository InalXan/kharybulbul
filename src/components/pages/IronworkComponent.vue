...
import NavigationComponent from "../general_components/NavigationComponent.vue";
import FooterComponent from "../general_components/FooterComponent.vue";

const products = [
  {
    image:
      "https://frankfurt.apollo.olxcdn.com/v1/files/o7ast2wqd5ez2-UZ/image;s=1000x700",
    name: "Reshotqa",
  },
  {
    image:
...
<template>
  ...
  <div
    id="container"
    class="bg-second text-gray-600 work-sans leading-normal text-base tracking-normal"
  >
    <NavigationComponent />
      ...
      <div class="carousel-inner relative overflow-hidden w-full">
        ...
        <div class="carousel-item absolute opacity-0" style="height: 50vh">
          <div
            ...
            style="
              background-image: url(&quot;https://images.pexels.com/photos/1108101/pexels-photo-1108101.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1&quot;);
            "
          >
            <div class="container mx-auto">
              ...
              >
                <p class="text-second text-2xl my-4">
                  Kreativ dizayna sahib konstruksiyalar hazırlayırıq
                </p>
                <RouterLink
                  class="text-xl text-primary inline-block no-underline border-b border-primary leading-relaxed hover:text-second hover:border-second"
                  to="/contact"
                  >Əlaqə</RouterLink
                >
              </div>
        ...
        >
          <div
            class="h-full w-full mx-auto flex pt-6 md:pt-0 md:items-center bg-cover bg-right"
            style="
              background-image: url(&quot;https://images.unsplash.com/photo-1641893823219-38b433f736c0?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&quot;);
            "
          >
            <div class="container mx-auto">
              <div
              ...
              >
                <p class="text-second text-2xl my-4">
                  İncə dizayna sahib konstruksiyalara sahib olun
                </p>
                <RouterLink
                  class="text-xl text-primary inline-block no-underline border-b border-gray-600 leading-relaxed hover:text-black hover:border-black"
                  to="/about"
        ...
        <div class="carousel-item absolute opacity-0" style="height: 50vh">
          <div
            ...
            style="
              background-image: url(&quot;https://images.pexels.com/photos/2381463/pexels-photo-2381463.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1&quot;);
            "
          >
            <div class="container mx-auto">
              <div
