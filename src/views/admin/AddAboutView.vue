    ...
    >
      <div class="flex items-center space-x-2 text-gray-400">
        <span class="text-green-700 tracking-wider font-thin text-md"
          ><RouterLink to="/admin/profile">Admin</RouterLink></span
        >
        <span>/</span>
        <span class="tracking-wide text-md">
          <span class="text-base">Haqqımızda</span>
        </span>
        <span>/</span>
      </div>
    </div>
    <div class="header my-3 h-12 px-10 flex items-center justify-between">
      <h1 class="font-medium text-2xl">Haqqımızda</h1>
    </div>
    <div class="flex flex-col mx-3 mt-6 lg:flex-row">
      <div class="w-full lg:w-1/3 m-1">
        <form class="w-full bg-second shadow-md p-6">
          <div class="flex flex-wrap -mx-3 mb-6">
            <div class="w-full md:w-full px-3 mb-6">
              <label
                class="block uppercase tracking-wide text-dark text-sm font-bold mb-2"
            ...
            <div class="w-full px-3 mb-6">
              <textarea
                textarea
                rows="4"
                class="appearance-none block w-full text-primary bg-white font-medium border border-gray-400 rounded-lg py-3 px-3 leading-tight focus:outline-none focus:border-primary"
                type="text"
                name="description"
                required
              >
